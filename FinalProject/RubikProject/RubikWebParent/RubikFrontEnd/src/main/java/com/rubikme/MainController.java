...
public class MainController {
	...
	@GetMapping("/c/features")
	public String viewFeatures(Model model, HttpServletRequest request) {
			
		return "features";
	}
	
	@GetMapping("/c/blog")
	public String viewBlog(Model model, HttpServletRequest request) {
